...
import (
	...
	"greenlight.kosta.net/internal/data"
	"greenlight.kosta.net/internal/validator"
)
...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	input.Filters.SortSafelist = []string{"title", "id", "year", "runtime", "-title", "-id", "-year", "-runtime"}
